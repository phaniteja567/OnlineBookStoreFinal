...
<i class="fa fa-home fa-fw"></i>Home <span class="border"></span></span></a></li>
						<li><a href="right-sidebar.html"><span>Products <span class="border"></span></span></a></li>
						<li><a href="contactUs"><span><i class="fa fa-phone fa-fw" ></i>ContactUs <span class="border"></span></span></a></li>
						<li><a href="AboutUs"><span><i class="fa fa-newspaper-o fa-fw" ></i>AboutUs <span class="border"></span></span></a></li>
...
<option value="2013">2013</option>
                   ...
                   <center> <input  style="background-color: black; color: white;" value="submit" type="submit"></center>
