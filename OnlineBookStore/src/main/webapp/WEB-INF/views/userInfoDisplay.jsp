			...
			<div class="container-fluid">
				...
				<div class="span9 margin-top">
                   <div class="span9 center margin-bottom"> 
					...
					<center>	<a href="logout" class="btn btn-primary pull-left">Submit</a></center>
						 </div>
						 <div class="span1 no_margin_left">
					 <center>	<button class="btn btn-danger pull-left " name="_eventId_cancel">Cancel</button></center>
					    </div>
					  </div>
					    </form:form></center>
				</div>
